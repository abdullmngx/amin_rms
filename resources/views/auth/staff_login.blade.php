...
<div class="col-xxl-4 col-lg-5">
        ...
        <div class="card-body p-4">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="username" id="emailaddress"  required="" placeholder="Enter your username/email">
    ...
    <div class="row mt-3">
        <div class="col-12 text-center">
            <p class="text-muted">Don't have an account? <a href="{{ route('staff.register') }}" class="text-muted ms-1"><b>Sign Up</b></a></p>
        </div> <!-- end col -->
    </div>
    <!-- end row -->
